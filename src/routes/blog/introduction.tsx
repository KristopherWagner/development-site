        ...
        <Grid as="article">
          ...
          <Card as="section" className="cols-full">
            ...
            <p>
              ...
              relentless researcher. I read tech specs, professional reviews,
              and user reviews; then wait a month before buying anything, just
              to be sure. I watch YouTube videos and read research papers to
              design my breakfast. I measure my coffee to the gram before
              putting it in a $12 French press, because the grinder ($400) and
              the beans ($25/pound) are where money is well-spent. 🤷‍♂ I also get
              paid to write code. 😬 I'm a little nervous writing a blog, and I
              can't promise I'll be consistent. But I hope to share products I
              actually use, walk through problems I've solved, and occasionally
              teach you something interesting. Absolute worst case, I'll write
          ...
          <Card as="section" className="cols-full">
            ...
            <p>
              ...
              running since 2005 when I saw Jerome Bettis sitting on the
              sideline with an oxygen mask on his face. I asked my dad what was
              wrong, and he told me that Bettis had asthma. I'd been struggling
              with asthma for years, and that day I decided: if Jerome Bettis
              could play in the NFL with it, I could live a normal life with it
              😌.
            </p>
          </Card>
          <Card as="section" className="cols-full">
          ...
          <Card as="section" className="cols-full">
            ...
            <p>
              <i>Barely</i>
              <br />
              🙃 I'm not a chef, though I do make a mean breakfast, so if you
              cook any of our
              <Link
          ...
          <Card as="section" className="cols-full">
            ...
            <p>
              ...
              words about a software engineer who runs, makes things, eats food
              that doesn't kill animals, and researches everything to an almost
